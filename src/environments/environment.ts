...
export const environment = {
  ...
  // API_BASE_PATH: "https://apiv2beta.atomex.net",

  // AUTH_BASE_PATH: "http://192.168.125.161:9092",
  AUTH_BASE_PATH: "https://authv2stage3.atomex.net",
  // API_BASE_PATH: "https://apiv2stage.atomex.net",
  API_BASE_PATH: "https://apiv2stage3.atomex.net",
  // API_BASE_PATH: "http://192.168.125.158:10045", //for click dest testing

  // logging: {
  //   // serverLoggingUrl: 'https://apiv2beta.atomex.net/v2/logging',
